            ...
            <form action="/order" method="post">
              @csrf
                  ...
                  <div class="row align-items-center text-white">
                    ...
                    <div class="col-lg-5 text-white">
                      <input type="text" name="harga" value="Rp. {{ number_format(HARGA, 0, ".", ".") }},-" readonly>
                    </div>
                  </div>
                  <hr>
                  <div class="row align-items-center text-white">
                    ...
                    <div class="col-lg-5 text-white">
                      <input type="text" name="jalur" value="{{ $kuota[0]->jalur }}" readonly>
                    </div>
                  </div>
                  <hr>
                  <div class="row align-items-center text-white">
                    ...
                    <div class="col-lg-5 text-white">
                      <input type="text" name="tanggal_naik" value="{{ $kuota[0]->tanggal }}" readonly>
                    </div>
                  </div>
                  <hr>
                  <div class="row align-items-center text-white">
                    ...
                    <div class="col-lg-5 text-white">
                      <input type="text" name="tanggal_turun" value="{{ Carbon\Carbon::parse( $kuota[0]->tanggal)->addDays(3)->format('Y-m-d') }}" readonly>
                    </div>
                  </div>
                  <hr>
                  <div class="row align-items-center text-white">
                    ...
                    <div class="col-lg-5 text-white">
                      <input type="number" name="jumlah_kuota"  min="4" required>
